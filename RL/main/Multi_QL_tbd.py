...
# --------------------
# Step Inbetween for TLS at Node 5
#---------------------

def get_state_Node5():  #for Node5
    global q_SB_3, q_SB_4, q_SB_5, current_phase
    
    # Detector IDs for Node1-2-EB
    detector_Node2_5_SB_0 = "Node2_5_SB_0"
    detector_Node2_5_SB_1 = "Node2_5_SB_1"
    detector_Node2_5_SB_2 = "Node2_5_SB_2"
    ...
    q_SB_3 = get_queue_length(detector_Node2_5_SB_0)
    q_SB_4 = get_queue_length(detector_Node2_5_SB_1)
    q_SB_5 = get_queue_length(detector_Node2_5_SB_2)
    
    # Get current phase index
    current_phase = get_current_phase(traffic_light_id)
    
    return (q_SB_3, q_SB_4, q_SB_5, current_phase)
...
for step in range(TOTAL_STEPS):
    ...
    state_Node5 = get_state_Node5()
    action = get_action_from_policy(state_Node5)
    apply_action(action)
